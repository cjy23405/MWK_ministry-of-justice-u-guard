    ...
    for (rowIndex = 0; rowIndex < rowsLength; rowIndex++) {
      for (colIndex = 0; colIndex < colsLength; colIndex++) {
        ...
        if (cellElement) {
          ...
          if (colIndex === currentColIndex && !(columns[colIndex].caption.length > 1 && rowIndex === 0 && cellElement.getAttribute('colspan') && !cellElement.getAttribute('rowspan'))) {
...
var SBLegacyMultiFixedrowheight = '50';
